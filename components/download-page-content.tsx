  ...
  return (
    <div className="py-8">
      ...
      <div className="text-center mb-16">
        <div className="inline-flex items-center gap-2 bg-yellow-100 dark:bg-yellow-900/20 text-yellow-800 dark:text-yellow-200 px-4 py-2 rounded-full text-sm font-medium mb-6">
      ...
      {/* Download Section - Moved Before Features */}
      <div className="max-w-3xl mx-auto mb-20">
        <div className="text-center mb-10">
          <h2 className="text-3xl font-bold mb-4">Choose Your Version</h2>
          <p className="text-muted-foreground">Select from all available versions below</p>
        </div>
      ...
      <div className="mb-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4">Why Choose Our MOD APK?</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <Card className="text-center group hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
            <CardHeader className="pb-4">
              <div className="bg-yellow-100 dark:bg-yellow-900/30 w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:bg-yellow-200 dark:group-hover:bg-yellow-800/40 transition-colors">
                <Zap className="w-8 h-8 text-yellow-600 dark:text-yellow-400" />
              </div>
              <CardTitle className="text-xl">Unlimited Features</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="text-center group hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
            <CardHeader className="pb-4">
              ...
              <CardTitle className="text-xl">Offline Play</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <div className="grid gap-6">
              {[
                ...
                <div key={index} className="flex items-start gap-4">
                  <div className="w-8 h-8 bg-yellow-500 text-white rounded-full flex items-center justify-center font-bold text-sm flex-shrink-0 mt-0.5">
                    {index + 1}
                  </div>
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-4">
                <h4 className="font-bold text-lg text-yellow-600 dark:text-yellow-400">Minimum Requirements</h4>
              ...
              <div className="space-y-4">
                <h4 className="font-bold text-lg text-yellow-600 dark:text-yellow-400">Recommended</h4>
                <div className="space-y-2">
                  {[
