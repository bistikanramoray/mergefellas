...
export async function generateMetadata({ params }: BlogPostPageProps): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: `https://mergefellas-apk.com/blog/${post.slug}`,

        ...(post.languages?.translations?.id && {
          id: `https://mergefellas-apk.com/id/blog/${post.languages.translations.id.slug}`,
        }),
      },
    },
    openGraph: {
      ...
      description,
      type: "article",
      url: `https://mergefellas-apk.com/blog/${post.slug}`,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 mt-8">
            ...
            <div className="lg:col-span-3">
              ...
              <div
                ...
                [&_h2]:bg-yellow-100 [&_h2]:dark:bg-yellow-900/20 [&_h2]:border-l-4 [&_h2]:border-yellow-500 [&_h2]:pl-4 [&_h2]:py-3 [&_h2]:rounded-r-lg [&_h2]:font-bold [&_h2]:text-xl [&_h2]:text-gray-900 [&_h2]:dark:text-white [&_h2]:my-6
                [&_h3]:border-b-2 [&_h3]:border-yellow-500 [&_h3]:pb-2 [&_h3]:font-bold [&_h3]:text-lg [&_h3]:text-gray-900 [&_h3]:dark:text-white [&_h3]:my-4
                [&_h4]:bg-yellow-100 [&_h4]:dark:bg-yellow-900/20 [&_h4]:border-l-4 [&_h4]:border-yellow-500 [&_h4]:pl-4 [&_h4]:py-2 [&_h4]:font-semibold [&_h4]:text-base [&_h4]:text-gray-900 [&_h4]:dark:text-white [&_h4]:my-3"
              >
                <BlogPost post={post} />
              </div>
            </div>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              mainEntityOfPage: {
                "@type": "WebPage",
                "@id": `https://mergefellas-apk.com/blog/${post.slug}`,
              },
              headline: decode(post.title),
              description: decode(post.excerpt).replace(/<[^>]*>/g, "").substring(0, 160),
              image: post.featured_image || "https://mergefellas-apk.com/logo.png",
              author: {
                "@type": "Organization",
                name: "Merge Fellas",
