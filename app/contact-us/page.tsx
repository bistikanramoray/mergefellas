...
// You can create a separate metadata.ts file or handle it in layout.tsx
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <div className="text-gray-700 dark:text-gray-300 mb-8">
            <p className="mb-4">
              If you have any questions, suggestions, or concerns regarding Merge Fellas MOD APK, we're here to help. 
              Whether you need assistance with downloading, installing, or understanding the features of the game, 
              feel free to reach out to us.
            </p>
            <p className="mb-4">
              You can contact us by filling out the form below. Please provide accurate details so we can respond 
              to your inquiry as quickly as possible.
            </p>
            <p className="mb-8">
              We value your feedback and strive to respond to all messages within a reasonable time.
            </p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  required
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 resize-vertical"
              ...
              <div>
                <button
                  ...
                  className="w-full md:w-auto px-6 py-3 bg-yellow-600 hover:bg-yellow-700 disabled:bg-yellow-400 text-white font-medium rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2 transition-colors duration-200"
                >
